...
<script lang="ts" setup name="ViewsDbmTreeForm">
  import { ref, unref, computed } from 'vue';
  import { useI18n } from '@jeesite/core/hooks/web/useI18n';
  import { useMessage } from '@jeesite/core/hooks/web/useMessage';
  import { router } from '@jeesite/core/router';
  import { Icon } from '@jeesite/core/components/Icon';
  import { BasicForm, FormProps, useForm } from '@jeesite/core/components/Form';
  import { BasicDrawer, useDrawerInner } from '@jeesite/core/components/Drawer';
  import { dbmTreeForm, dbmTreeSave } from '@jeesite/dbm/api/dbm/tree';
  ...
  const [registerDrawer, { setDrawerProps, closeDrawer }] = useDrawerInner(async (data) => {
    ...
    await resetFields();
    const res = await dbmTreeForm(data);
  ...
  async function handleSubmit() {
    try {
      ...
      const res = await dbmTreeSave(data);

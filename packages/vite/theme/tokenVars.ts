import { MapToken } from 'antdv-next/dist/theme/interface/maps/index';
import formatToken from 'antdv-next/dist/theme/util/alias';

export default function tokenVars(mapToken: MapToken) {

...
<h3 align="center" style="margin:30px 0 30px;font-weight:bold;font-size:30px;">微服务开发平台 - Spring Cloud 2021</h3>
<p align="center">
...
* 源码仓库地址：
  [Gitee](https://gitee.com/thinkgem/jeesite-cloud/tree/v5.springboot2.cloud)、
  [GitCode](https://gitcode.com/thinkgem/jeesite-cloud/tree/v5.springboot2.cloud)、
  [GitHub](https://github.com/thinkgem/jeesite-cloud/tree/v5.springboot2.cloud)
* 分离版源码仓库地址：
...
* 源码合集仓库地址：
  [GVP](https://gitee.com/thinkgem/jeesite/tree/v5.springboot2.cloud)、
  [G-Star](https://gitcode.com/thinkgem/jeesite/tree/v5.springboot2.cloud)、
  [GitHub](https://github.com/thinkgem/jeesite/tree/v5.springboot2.cloud)
...
* Flowable业务流程引擎（BPM）：<https://jeesite.com/docs/bpm/>
...
* 在每个微服务中可以找的 `bootstrap.yml` 设置注册和配置服务地址

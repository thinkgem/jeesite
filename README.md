...
<h3 align="center" style="margin:30px 0 30px;font-weight:bold;font-size:30px;">快速开发平台 - Spring Boot 4</h3>
<p align="center">
 <a href="https://spring.io/projects/spring-boot" target="__blank"><img alt="SpringBoot-V4.1 or 3.5 or 2.7" src="https://img.shields.io/badge/SpringBoot-V4.1 or 3.5 or 2.7-blue.svg"></a>
...
* 源码合集仓库地址：
  [GVP](https://gitee.com/thinkgem/jeesite/tree/v5.springboot4)、
  [G-Star](https://gitcode.com/thinkgem/jeesite/tree/v5.springboot4)、
  [GitHub](https://github.com/thinkgem/jeesite/tree/v5.springboot4)
...
* 融合 AI 大模型能力，为您的项目筑牢稳定工程底座，补齐纯 AI 生成代码架构零散、规范缺失、难以规模化投产的工程化短板。
...
* 主框架：Spring Boot 4、Spring Framework 7、Apache Shiro、J2Cache
* 持久层：Apache MyBatis 3、Hibernate Validator 9、Alibaba Druid
...
* 工作流引擎：Flowable 8、符合 BPMN 规范、在线流程设计器、中国式流程、退回、撤回、自由流
...
| web-ai-cms | 仅包含 CMS 和 AI 模块，AI 助手，AI 对话，Tool MCP 调用      |
| web-ai-mcp | 人工智能 AI 模块的 MCP 服务端，提供 Tool 调用实现             |

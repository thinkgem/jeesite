...
(function () {
    var title = $G("J_title"),
        ...
        customTableWidth = $G("J_customTableWidth"), // ThinkGem 2017-11-14 新增自定义表格宽度
        tone = $G("J_tone"),
        me,
        preview = $G("J_preview");
    ...
    editTable.prototype = {
        init:function () {
            ...
            domUtils.on(customTableWidth, "click", me.customTableWidthHanler); // ThinkGem 2017-11-14 新增自定义表格宽度
    ...
    dialog.onok = function () {
        ...
        customTableWidth.checked ? editor.execCommand("adaptbycustom",
        		$G("J_customTableWidthInput").value) : ""; // ThinkGem 2017-11-14 新增自定义表格宽度

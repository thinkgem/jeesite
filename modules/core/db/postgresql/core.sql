...
COMMENT ON TABLE js_sys_biz_category IS '业务分类';
COMMENT ON COLUMN js_sys_biz_category.category_code IS '流程分类';
COMMENT ON COLUMN js_sys_biz_category.view_code IS '分类代码';
COMMENT ON COLUMN js_sys_biz_category.category_name IS '分类名称';
COMMENT ON COLUMN js_sys_biz_category.parent_code IS '父级编号';
COMMENT ON COLUMN js_sys_biz_category.parent_codes IS '所有父级编号';
COMMENT ON COLUMN js_sys_biz_category.tree_sort IS '排序号（升序）';
COMMENT ON COLUMN js_sys_biz_category.tree_sorts IS '所有排序号';
COMMENT ON COLUMN js_sys_biz_category.tree_leaf IS '是否最末级';
COMMENT ON COLUMN js_sys_biz_category.tree_level IS '层次级别';
COMMENT ON COLUMN js_sys_biz_category.tree_names IS '全节点名';
COMMENT ON COLUMN js_sys_biz_category.status IS '状态（0正常 1删除 2停用）';
COMMENT ON COLUMN js_sys_biz_category.create_by IS '创建者';
COMMENT ON COLUMN js_sys_biz_category.create_date IS '创建时间';
COMMENT ON COLUMN js_sys_biz_category.update_by IS '更新者';
COMMENT ON COLUMN js_sys_biz_category.update_date IS '更新时间';
COMMENT ON COLUMN js_sys_biz_category.remarks IS '备注信息';
COMMENT ON COLUMN js_sys_biz_category.corp_code IS '租户代码';
COMMENT ON COLUMN js_sys_biz_category.corp_name IS '租户名称';

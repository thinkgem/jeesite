...
CREATE INDEX idx_biz_category_vc ON js_biz_category (view_code ASC);
CREATE INDEX idx_biz_category_pc ON js_biz_category (parent_code ASC);
CREATE INDEX idx_biz_category_pcc ON js_biz_category (parent_codes ASC);
CREATE INDEX idx_biz_category_ts ON js_biz_category (tree_sort ASC);
CREATE INDEX idx_biz_category_tss ON js_biz_category (tree_sorts ASC);
CREATE INDEX idx_biz_category_st ON js_biz_category (status ASC);
CREATE INDEX idx_biz_category_cc ON js_biz_category (corp_code ASC);
...
CREATE INDEX idx_sys_menu_ds_st ON js_sys_menu_data_scope (status ASC);
...
CREATE INDEX idx_sys_role_fs_fc ON js_sys_role_field_scope (role_code ASC);
CREATE INDEX idx_sys_role_fs_mc ON js_sys_role_field_scope (menu_code ASC);
CREATE INDEX idx_sys_role_fs_st ON js_sys_role_field_scope (status ASC);
CREATE INDEX idx_sys_role_fs_ec ON js_sys_role_field_scope (entity_class ASC);

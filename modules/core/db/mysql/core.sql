...
CREATE INDEX idx_sys_menu_fs_fc ON js_sys_role_field_scope (role_code ASC);
CREATE INDEX idx_sys_menu_fs_mc ON js_sys_role_field_scope (menu_code ASC);
CREATE INDEX idx_sys_menu_fs_st ON js_sys_role_field_scope (status ASC);
CREATE INDEX idx_sys_menu_fs_ec ON js_sys_role_field_scope (entity_class ASC);

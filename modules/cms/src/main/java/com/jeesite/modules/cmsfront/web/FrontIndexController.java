...
public class FrontIndexController extends BaseController {
	...
	public String index(Model model) {
		return REDIRECT + frontPath + "/index-" + CmsSite.MAIN_SITE_CODE + ".html";
	}
	...
	public String index(@PathVariable String siteCode, Model model) {
		// 如果是主站，获取主站信息并进入主页
		if (CmsSite.isMainSite(siteCode)) {
		...
		// 否则显示子站第一个栏目
		List<CmsCategory> mainNavList = CmsUtils.getMainNavList(siteCode);
		...
		// 站点中无栏目，则显示栏目分类空白页
			...
			return "modules/cmsfront/themes/" + site.getTheme() + "/" + CmsCategory.DEFAULT_TEMPLATE + "Category";
		}
	}

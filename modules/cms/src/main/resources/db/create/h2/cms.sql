...
COMMENT ON COLUMN ${_prefix}cms_article.article_source IS '来源（转载/原创）';
...
COMMENT ON COLUMN ${_prefix}cms_guestbook.gb_type IS '留言分类';
...
COMMENT ON COLUMN ${_prefix}cms_site.domain_name IS '站点域名';

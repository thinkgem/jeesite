...
<head>
	...
	<table class="table table-striped ">
		...
		<tr>
			<td>实际结束时间：</td>
			<td>
				<input id="realityEndTime" readonly="readonly" maxlength="20" class=" Wdate required" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',isShowClear:false});"/>
			</td>
		</tr>
	</table>
	</script>
			...
			<tr>
				...
				<td>
					<select id="leaveType" name="leaveType">
						<c:forEach items="${fns:getDictList('oa_workflow_leave_type')}" var="leaveType">

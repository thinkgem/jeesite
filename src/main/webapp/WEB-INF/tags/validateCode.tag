...
<%@ attribute name="id" type="java.lang.String" required="false" description="验证框ID"%>
...
<input type="text" id="${not empty id?id:name}" name="${name}" maxlength="5" class="txt required" style="font-weight:bold;width:45px;${inputCssStyle}"/>

...
public class FrontController extends BaseController {
	...
	public String commentSave(Comment comment, String validateCode,
			@RequestParam(required = false) String replyId, HttpServletRequest request) {
			...
			if (ValidateCodeServlet.validate(request, validateCode)) {
				if (StringUtils.isNotBlank(replyId)) {
					...
					if (replyComment != null) {
						comment.setContent(new StringBuilder("<div class=\"reply\">")
								.append(replyComment.getName())
								.append(":<br/>")
								.append(replyComment.getContent())
								.append("</div>")
